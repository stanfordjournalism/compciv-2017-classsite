...
# -*- coding: utf-8 -*-
#
# Guide to Computational Methods in the Civic Sphere documentation build configuration file, created by
...
man_pages = [
    (master_doc, 'guidetocomputationalmethodsinthecivicsphere', 'Guide to Computational Methods in the Civic Sphere Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'GuidetoComputationalMethodsintheCivicSphere', 'Guide to Computational Methods in the Civic Sphere Documentation',
     author, 'GuidetoComputationalMethodsintheCivicSphere', 'One line description of project.',
     'Miscellaneous'),
]
